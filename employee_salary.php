...
<h2 class="art-PostHeader" align="left">Employee Salary View </h2>
...
<table width="70%" border="1" align="center" class="table">
  <tr>
    <td colspan="6" align="right" ><strong><a href="Javascript:delete_multiple_employee()">Delete</a> | <a href="Javascript:window.print()">Print</a> </strong></td>
  </tr>
  <tr>
    <th >Check</th>
    <th >Id no. </th>
  ...
  <tr>
    ...
    <td ><a href="salary_add.php?em_id=<?=$data['em_id']?>" rel="facebox">Salary </a></td>
  </tr>
  <?php } ?>
</table>
